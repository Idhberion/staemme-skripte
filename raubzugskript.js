...
// @version 1.2
// @description Rechnet/FÃ¼gt die Truppen fÃ¼r die jeweiligen Raubzugstufen aus/ein
// @author TheHebel97, Osse, the wise
...
(function () {
    ...
    setTimeout(function () {
        ...
        function getTroopsPerRzSlot(amount, level, calcType) { // eigentliche Rechnung, ordnet die bh plÃ¤tze den RaubzÃ¼gen zu  // hier parameter einfÃ¼gen fÃ¼r andere Berechnungsarten
            let weigths
        ...
        function setupUI() {
            ...
            $(".candidate-squad-widget > tbody > tr").eq(1).append('<td><img class="quickbar_image" title="Anzahl der Truppen vorgeben, falls nur ein Teil für die Raubzüge verwendet werden soll. Wenn alle Truppen verwendet werden sollen, entweder auf "Alle Truppen" klicken oder alle Felder frei lassen. Jetzt nur noch auf "Raubzug senden" klicken und nacheinander auf "Start" klicken." data-src="https://dsde.innogamescdn.com/asset/ed7de11c/graphic/command/support.png" alt="" src="https://dsde.innogamescdn.com/asset/ed7de11c/graphic/command/support.png"></td>');
